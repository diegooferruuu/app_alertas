...
let VerifyIdentityDto = (() => {
    var _a;
    let _id_card_base64_decorators;
    let _id_card_base64_initializers = [];
    let _id_card_base64_extraInitializers = [];
    return _a = class VerifyIdentityDto {
            constructor() {
                this.id_card_base64 = __runInitializers(this, _id_card_base64_initializers, void 0);
                __runInitializers(this, _id_card_base64_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _id_card_base64_decorators = [(0, class_validator_1.IsBase64)()];
