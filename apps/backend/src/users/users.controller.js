...
let UsersController = (() => {
    ...
    (() => {
        ...
        _updateUser_decorators = [(0, common_1.Put)('/:id'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
        _getProfile_decorators = [(0, common_1.Get)('/profile/me'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
