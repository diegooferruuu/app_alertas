...
let AuthController = (() => {
    ...
    let _verifyIdentity_decorators;
    ...
    var AuthController = _classThis = class {
        ...
        async verifyIdentity(user, verifyIdentityDto) {
            return this.verificationService.verifyIdentity(user.userId, verifyIdentityDto.id_card_base64);
        }
    ...
    (() => {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, common_1.UseGuards)(local_auth_guard_1.LocalAuthGuard)];
        _refreshToken_decorators = [(0, common_1.Post)('refresh')];
        _verifyIdentity_decorators = [(0, common_1.Post)('verify-identity'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
        ...
        __esDecorate(_classThis, null, _verifyIdentity_decorators, { kind: "method", name: "verifyIdentity", static: false, private: false, access: { has: obj => "verifyIdentity" in obj, get: obj => obj.verifyIdentity }, metadata: _metadata }, null, _instanceExtraInitializers);
